...
class ViewRecentHelpRequestsTable
    extends SupabaseTable<ViewRecentHelpRequestsRow> {
  @override
  String get tableName => 'view_recent_help_requests';

  @override
  ViewRecentHelpRequestsRow createRow(Map<String, dynamic> data) =>
      ViewRecentHelpRequestsRow(data);
}

class ViewRecentHelpRequestsRow extends SupabaseDataRow {
  ViewRecentHelpRequestsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewRecentHelpRequestsTable();
