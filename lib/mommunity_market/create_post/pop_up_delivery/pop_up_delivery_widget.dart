...
import 'pop_up_delivery_model.dart';
export 'pop_up_delivery_model.dart';

class PopUpDeliveryWidget extends StatefulWidget {
  const PopUpDeliveryWidget({super.key});

  @override
  State<PopUpDeliveryWidget> createState() => _PopUpDeliveryWidgetState();
}

class _PopUpDeliveryWidgetState extends State<PopUpDeliveryWidget> {
  late PopUpDeliveryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopUpDeliveryModel());
                          ...
                          onTap: () async {
                            if (_model.deliveryBool == false) {
                              FFAppState().updateMarketPlaceMetaStruct(
                                (e) => e..deliveryMethod = 'No delivery',
                              );
                              safeSetState(() {});
                            }
                            Navigator.pop(context);
