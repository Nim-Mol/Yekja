...
class FilterModelwithDetailsTableStruct extends BaseStruct {
  ...
  set detailsText(String? val) => _detailsText = val;
  ...
  static FilterModelwithDetailsTableStruct? maybeFromMap(dynamic data) => data
          is Map
      ? FilterModelwithDetailsTableStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static FilterModelwithDetailsTableStruct fromSerializableMap(
  ...
  @override
  String toString() => 'FilterModelwithDetailsTableStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is FilterModelwithDetailsTableStruct &&
...
FilterModelwithDetailsTableStruct createFilterModelwithDetailsTableStruct({
  int? mainCatId,
  String? postId,
  String? catName,
  String? city,
