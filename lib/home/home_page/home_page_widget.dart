                            ...
                            Flexible(
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '558fzs8h' /* What are you looking for today... */,
                                    ),
                                        ...
                                        children: [
                                          ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.asset(
                                              'assets/images/ChatGPT_Image_Jun_9,_2025,_09_35_58_AM.png',
                                              width: 300.0,
                                              height: 300.0,
                                              fit: BoxFit.cover,
                                            ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'pshx57tg' /* What’s Around You? Swipe to Se... */,
                                ),
                                  ...
                                  children: [
                                    TextSpan(
                                      text: FFLocalizations.of(context).getText(
                                        'nl42s9kh' /* Swipe through a world of exist... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                              ...
                              Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context
                                        .pushNamed(SwipableMAWidget.routeName);
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    '45nxx23g' /* Start */,
                                  ),
                                                            ...
                                                            Align(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'hzf4lfor' /* For your Community support, we... */,
                                                                ),
                                                                textAlign:
                                                                    TextAlign
                                                                        .center,
                                                            ...
                                                            Align(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'gjeiq4pf' /* For your Community support, we... */,
                                                                ),
                                                                textAlign:
                                                                    TextAlign
                                                                        .center,
                                                              ...
                                                              Align(
                                                                ...
                                                                child: Text(
                                                                  FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'celsaycw' /* For your Community support, we... */,
                                                                  ),
                                                                  textAlign:
                                                                      TextAlign
                                                                          .center,
