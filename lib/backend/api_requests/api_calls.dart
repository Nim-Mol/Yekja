...
class TestLanguageCall {
  static Future<ApiCallResponse> call() async {
    return ApiManager.instance.makeApiCall(
      callName: 'testLanguage',
      apiUrl:
          'https://bkygphvuuqmpmcfrncpm.supabase.co/rest/v1/{resource}?select=*&order=created_at.desc.nullslast&limit=1',
      callType: ApiCallType.GET,
      headers: {
        'apikey':
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJreWdwaHZ1dXFtcG1jZnJuY3BtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA1MjI3NjIsImV4cCI6MjA2NjA5ODc2Mn0.XHXZMXvuTQBe6vjI0xs-m8ztvxhmIImd8JJpV-LYAds',
      ...
      params: {
        'resource': "view_post_search_{{appState.appLang}}",
      },
      returnBody: true,
      encodeBodyUtf8: false,
      decodeUtf8: false,
