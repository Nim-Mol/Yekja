  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ViewTopSubcategoriesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ViewTopSubcategoriesRow> mainPageViewTopSubcategoriesRowList =
            snapshot.data!;
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final categories =
                                                  mainPageViewTopSubcategoriesRowList
                                                      .where((e) =>
                                                          _model.mainCat ==
                                                          e.mainCatId)
                                                      .toList()
                                        ...
                                        FutureBuilder<List<ViewShoutoutRow>>(
                                          future: _model.shoutout(
                                            requestFn: () =>
                                                ViewShoutoutTable().queryRows(
                                              queryFn: (q) =>
                                                  q.order('created_at'),
                                              limit: 10,
                                            ),
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<ViewShoutoutRow>
                                                carouselViewShoutoutRowList =
                                                snapshot.data!;
                                                ...
                                                itemBuilder: (context,
                                                  ...
                                                  return wrapWithModel(
                                                    ...
                                                    child: ShoutOutCardWidget(
                                                      key: Key(
                                                        'Keyy8a_${carouselViewShoutoutRow.id!.toString()}',
                                                      ),
                                                      shoutOutId:
                                                          carouselViewShoutoutRow
                                                              .id!,
                                              ...
                                              child: PagedListView<
                                                ...
                                                builderDelegate:
                                                  ...
                                                  itemBuilder: (context, _,
                                                      filterResultsIndex) {
                                                    final filterResultsItem =
                                                        _model.listviewSupportPagingController!
                                                                .itemList![
                                                            filterResultsIndex];
                                                    return InkWell(
                                                      splashColor:
                                              ...
                                              child: GestureDetector(
                                                ...
                                                child: ConfirmCancelPopUpWidget(
                                                  header: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'gc05phyx' /* Thank you for standing by your... */,
                                                  ),
                                                  hintText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'sbf5857h' /* We’re currently working on thi... */,
                                                  ),
                                                  cancelText:
                                                      FFLocalizations.of(
                                                              context)
                                                  ...
                                                  confirmText:
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                    'qfql1dwd' /* Yes, count me in */,
                                                  ),
                                                  onConfirmAction: () async {
                                                    await ContactYekjaTable()
                                                        .insert({
                                                      'subject':
                                                          'Request to become volunteer',
                                                      'user_id': currentUserUid,
                                                      'message':
                                                          'YEKJA automated message: Potential Volunteer!!!',
                                                    });
                                                  },
                                              ...
                                              child: PagedListView<
                                                ...
                                                builderDelegate:
                                                  ...
                                                  itemBuilder: (context, _,
                                                      filterResultsIndex) {
                                                    final filterResultsItem =
                                                        _model.listviewSkillsPagingController!
                                                                .itemList![
                                                            filterResultsIndex];
                                                    return InkWell(
                                                      splashColor:
                                                ...
                                                child: GestureDetector(
                                                  ...
                                                  child:
                                                    ...
                                                    header: FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                      'd1bm6zmi' /* This feature will be available... */,
                                                    ),
                                                    hintText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      '0krw2ji5' /* We’re currently working on bus... */,
                                                    ),
                                                    cancelText:
                                                        FFLocalizations.of(
                                                                context)
                                                    ...
                                                    onConfirmAction: () async {
                                                      await ContactYekjaTable()
                                                        ...
                                                        'user_id':
                                                            currentUserUid,
                                                        'message':
                                                            'YEKJA automated message: Potential Business User!!!',
                                                      });
                                                    },
                                                    onCancelAction: () async {
                                                      Navigator.pop(context);
