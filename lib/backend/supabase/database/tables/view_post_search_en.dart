...
class ViewPostSearchEnTable extends SupabaseTable<ViewPostSearchEnRow> {
  @override
  String get tableName => 'view_post_search_en';

  @override
  ViewPostSearchEnRow createRow(Map<String, dynamic> data) =>
      ViewPostSearchEnRow(data);
}

class ViewPostSearchEnRow extends SupabaseDataRow {
  ViewPostSearchEnRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewPostSearchEnTable();
