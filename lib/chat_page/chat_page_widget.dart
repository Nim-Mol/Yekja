...
class _ChatPageWidgetState extends State<ChatPageWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ViewUserChatsRow>>(
      future: ViewUserChatsTable().queryRows(
        queryFn: (q) => q
      ...
      builder: (context, snapshot) {
        ...
        List<ViewUserChatsRow> chatPageViewUserChatsRowList = snapshot.data!;
                    ...
                    children: [
                      ...
                      if (_model.choiceChipsValue == 'All')
                        Builder(
                          builder: (context) {
                            final chatview =
                                chatPageViewUserChatsRowList.toList();
                      ...
                      if (_model.choiceChipsValue == 'My Posts')
                        Builder(
                          builder: (context) {
                            final chatview = chatPageViewUserChatsRowList
                                .where(
                                    (e) => e.postOwnerId == widget.profileid)
                                .toList();
