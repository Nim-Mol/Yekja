...
class ProfileEditCopyWidget extends StatefulWidget {
  ...
  static String routeName = 'ProfileEditCopy';
  static String routePath = '/editProfileTest';
                                                                  ...
                                                                  TextFormField(
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      hintText:
                                                                          FFLocalizations.of(context)
                                                                              .getText(
                                                                        '7k120zgx' /* A unique name to  display on y... */,
                                                                      ),
                                                                  ...
                                                                  TextFormField(
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      hintText:
                                                                          FFLocalizations.of(context)
                                                                              .getText(
                                                                        '8ly2mjo6' /* Let everyone know about you. */,
                                                                      ),
                                                                      hintStyle: FlutterFlowTheme.of(
                                                                              context)
                                                                          .labelMedium
