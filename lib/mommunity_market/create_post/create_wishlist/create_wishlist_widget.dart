...
class CreateWishlistWidget extends StatefulWidget {
  ...
  static String routeName = 'CreateWishlist';
  static String routePath = '/createWishlist';
                                  ...
                                  if (FFAppState().marketPlaceMeta.catId == 3)
                                    Column(
                                      ...
                                      children: [
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '987ihbyw' /* In a few lines, say what you n... */,
                                                      ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'n7broe87' /* Add categories to help your po... */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                        ...
                                        if (_model.switchVisibilityValue ==
                                            true)
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              if ((FFAppState().marketPlaceMeta.catId != 3) ||
                                  ...
                                  (FFAppState()
                                      ...
                                      0)) {
                                context.pushNamed(
                                  CreateItemImagesWidget.routeName,
                                  extra: <String, dynamic>{
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: (FFAppState().marketPlaceMeta.catId !=
                                              3) ||
                                          (FFAppState()
                                                      .marketPlaceMeta
                                                      .exchangeDescription !=
