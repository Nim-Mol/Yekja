...
import 'post_prev_model.dart';
export 'post_prev_model.dart';

class PostPrevWidget extends StatefulWidget {
  const PostPrevWidget({super.key});

  static String routeName = 'PostPrev';
  static String routePath = '/PostPrev';

  @override
  State<PostPrevWidget> createState() => _PostPrevWidgetState();
}

class _PostPrevWidgetState extends State<PostPrevWidget>
    with TickerProviderStateMixin {
  late PostPrevModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostPrevModel());
