...
class MessagesDeleteTable extends SupabaseTable<MessagesDeleteRow> {
  @override
  String get tableName => 'messagesDelete';

  @override
  MessagesDeleteRow createRow(Map<String, dynamic> data) =>
      MessagesDeleteRow(data);
}

class MessagesDeleteRow extends SupabaseDataRow {
  MessagesDeleteRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MessagesDeleteTable();
