...
class _ProfilePageCopyWidgetState extends State<ProfilePageCopyWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UserExtRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserExtRow> profilePageCopyUserExtRowList = snapshot.data!;

        final profilePageCopyUserExtRow =
            profilePageCopyUserExtRowList.isNotEmpty
                ? profilePageCopyUserExtRowList.first
                : null;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Stack(
                children: [
                  FutureBuilder<List<ConsentsRow>>(
                                        ...
                                        child: Container(
                                          ...
                                          child:
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              final rowConsentsRow =
                                                  rowConsentsRowList.isNotEmpty
                                                      ? rowConsentsRowList.first
                                                      : null;
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'kr4e72hp' /* 12 points to reach level 4 */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelLarge
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        List<ViewPostSearchRow>
                                                            listViewViewPostSearchRowList =
                                                            snapshot.data!;
                                                        ...
                                                        return ListView.builder(
                                                          ...
                                                          itemBuilder: (context,
                                                              listViewIndex) {
                                                            final listViewViewPostSearchRow =
                                                                listViewViewPostSearchRowList[
                                                                    listViewIndex];
                                                            return InkWell(
                                                              splashColor: Colors
                                                              ...
                                                              child:
                                                                ...
                                                                child:
                                                                  ...
                                                                  key: Key(
                                                                    'Keyk59_${listViewViewPostSearchRow.sourceId!}',
                                                                  ),
                                                                  profileId: widget
                                                                      .profileId,
                                                                  itemData:
                                                                      ItemCardHorizentalStruct(
                                                                    title: listViewViewPostSearchRow
                                                                        .title,
                                                                    description:
                                                                        listViewViewPostSearchRow
                                                                            .description,
                                                                    ...
                                                                    createdAt:
                                                                        listViewViewPostSearchRow
                                                                            .createdAt,
                                                                    catID: listViewViewPostSearchRow
                                                                        .subCatId,
                                                                    itemLikes:
                                                                        listViewViewPostSearchRow
                                                                            .postLikes,
                                                                    mainImagePath: listViewViewPostSearchRow.images.firstOrNull !=
                                                                                null &&
                                                                            listViewViewPostSearchRow.images.firstOrNull !=
                                                                                ''
                                                                        ? listViewViewPostSearchRow
                                                                            .images
                                                                            .firstOrNull
                                                                  ...
                                                                  postId: listViewViewPostSearchRow
                                                                      .sourceId,
                                                                ),
                                                              ),
                                                            );
                                                              ...
                                                              itemBuilder: (context,
                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  child:
                                                                      ItemCardHorizentalWidget(
                                                                    key: Key(
                                                                        'Keyqsc_${listViewIndex}_of_${listViewViewUserFavoritesRowList.length}'),
                                                                    itemData:
                                                                        ItemCardHorizentalStruct(
                                                          ...
                                                          return ListView
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return ReviewCardWidget(
                                                                key: Key(
                                                                    'Key36k_${listViewIndex}_of_${listViewViewUserReviewsRowList.length}'),
                                                                reviewData:
