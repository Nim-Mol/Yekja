                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'c4rjjccb' /* Details build trust and save b... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '77uuem4d' /* There can always be someone wh... */,
                                              ),
                                              maxLines: 2,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'n7rm4sxc' /* What are you hoping to swap th... */,
                                            ),
                                            maxLines: 2,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: ErrorPopUpWidget(
                                          errorText: FFLocalizations.of(context)
                                              .getText(
                                            'er5xc5je' /* Some fields are empty Please t... */,
                                          ),
                                        ),
                                      ),
                                    );
