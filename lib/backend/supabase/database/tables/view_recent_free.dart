...
class ViewRecentFreeTable extends SupabaseTable<ViewRecentFreeRow> {
  @override
  String get tableName => 'view_recent_free';

  @override
  ViewRecentFreeRow createRow(Map<String, dynamic> data) =>
      ViewRecentFreeRow(data);
}

class ViewRecentFreeRow extends SupabaseDataRow {
  ViewRecentFreeRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewRecentFreeTable();
