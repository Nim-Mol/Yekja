...
class DeletedPostsTable extends SupabaseTable<DeletedPostsRow> {
  @override
  String get tableName => 'deleted_posts';

  @override
  DeletedPostsRow createRow(Map<String, dynamic> data) => DeletedPostsRow(data);
}

class DeletedPostsRow extends SupabaseDataRow {
  DeletedPostsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => DeletedPostsTable();
