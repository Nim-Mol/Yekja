...
import '/posts/create_post/city/city_widget.dart';
...
import 'post_general_detail_copy2_model.dart';
export 'post_general_detail_copy2_model.dart';

class PostGeneralDetailCopy2Widget extends StatefulWidget {
  const PostGeneralDetailCopy2Widget({super.key});

  static String routeName = 'PostGeneralDetailCopy2';
  static String routePath = '/postGeneralDetailCopy2';

  @override
  State<PostGeneralDetailCopy2Widget> createState() =>
      _PostGeneralDetailCopy2WidgetState();
}

class _PostGeneralDetailCopy2WidgetState
    extends State<PostGeneralDetailCopy2Widget> {
  late PostGeneralDetailCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostGeneralDetailCopy2Model());
...
and Descripti... */
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'jss7ovcj' /* Helps others understand your p... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
