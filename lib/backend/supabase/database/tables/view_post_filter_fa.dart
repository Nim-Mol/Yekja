...
class ViewPostFilterFaTable extends SupabaseTable<ViewPostFilterFaRow> {
  @override
  String get tableName => 'view_post_filter_fa';

  @override
  ViewPostFilterFaRow createRow(Map<String, dynamic> data) =>
      ViewPostFilterFaRow(data);
}

class ViewPostFilterFaRow extends SupabaseDataRow {
  ViewPostFilterFaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewPostFilterFaTable();
