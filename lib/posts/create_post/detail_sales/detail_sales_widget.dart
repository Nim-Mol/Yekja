                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'gbnahsqm' /* Helps others understand your p... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      child: FlutterFlowChoiceChips(
                                        options: [
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'ob4y7gwi' /* By Agreement */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'pjnp2ul8' /* Pick-Up Only */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            '2qeln0on' /* Sent by Post */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'nchk47pw' /* Free Delivery */,
                                          ))
                                        ],
                                        onChanged: (val) async {
                                          safeSetState(() =>
                                                        ...
                                                        options: [
                                                          ChipData(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                            'lfw1zl4w' /* Under €1,000 */,
                                                          )),
                                                          ChipData(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                            'cpveulx3' /* Under €2,000 */,
                                                          )),
                                                          ChipData(
                                                              FFLocalizations.of(
                                                                      context)
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'p31bqpjt' /* Try item exchange, not just pa... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '38e3zjus' /* Please insert a wishlist for w... */,
                                                ),
                                                maxLines: 2,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '7wb6t8yv' /* What items are you looking to ... */,
                                                  ),
                                                  hintStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
