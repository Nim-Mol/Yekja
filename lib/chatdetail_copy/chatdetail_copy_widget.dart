...
import 'chatdetail_copy_model.dart';
export 'chatdetail_copy_model.dart';

class ChatdetailCopyWidget extends StatefulWidget {
  const ChatdetailCopyWidget({
    super.key,
  ...
  static String routeName = 'chatdetailCopy';
  static String routePath = '/chatdetailCopy';

  @override
  State<ChatdetailCopyWidget> createState() => _ChatdetailCopyWidgetState();
}

class _ChatdetailCopyWidgetState extends State<ChatdetailCopyWidget> {
  late ChatdetailCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatdetailCopyModel());
                                        ...
                                        if (((currentUserUid !=
                                          ...
                                          wrapWithModel(
                                            ...
                                            child: ReviewAndRatingWidget(
                                              key: Key(
                                                'Keyx98_${widget.chatId!.toString()}',
                                              ),
