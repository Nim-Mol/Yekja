...
class FilterApiCall {
  static Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'filterApi',
      apiUrl:
          'https://bkygphvuuqmpmcfrncpm.supabase.co/rest/v1/view_post_search_${langCode}?select=*&main_cat_id=eq.${mainCatId}&cat_id=eq.${catId}&order=${sortby}',
...
class SearchfilerapiCall {
  static Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          'https://bkygphvuuqmpmcfrncpm.supabase.co/rest/v1/view_post_filter_${langCode}?select=*&or=(title.ilike.*${term}*,description.ilike.*${term}*,city.ilike.*${term}*,sub_cat_name.ilike.*${term}*,cat_name.ilike.*${term}*, sub_cat_name_label.ilike.*${term}*, cat_name_label.ilike.*${term}*)&order=${sortby}&cat_id=in.(${catIdsCsv})&unique_subcat_id=in.(${subCatIdsCsv})&city_id=in.(${cityIdsCsv})&yekja_verified=in.(${verifiedCsv})&post_likes=gte.${likes}&has_images=in.(${hasimg})',
      callType: ApiCallType.GET,
      headers: {
        'apikey':
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJreWdwaHZ1dXFtcG1jZnJuY3BtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA1MjI3NjIsImV4cCI6MjA2NjA5ODc2Mn0.XHXZMXvuTQBe6vjI0xs-m8ztvxhmIImd8JJpV-LYAds',
