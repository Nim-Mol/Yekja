                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '4ryihxff' /* Insert the relevant date */,
                              ),
                    ...
                    child: Padding(
                      ...
                      child: FlutterFlowCalendar(
                        ...
                        onChange: (DateTimeRange? newSelectedDate) async {
                          ...
                          _model.selected = _model.calendarSelectedDay?.start;
                          safeSetState(() {});
                          safeSetState(() {});
                        },
                        ...
                        dayOfWeekStyle: FlutterFlowTheme.of(context)
                            ...
                            .override(
                              ...
                              color: FlutterFlowTheme.of(context).lighterGreen,
                              letterSpacing: 0.0,
                              lineHeight: 1.0,
                              useGoogleFonts: !FlutterFlowTheme.of(context)
                                  .bodyLargeIsCustom,
                      ...
                      Builder(
                        builder: (context) => Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              if (widget.dateFieldName == 'available_from') {
                                ...
                                if (widget.dateFieldName == 'deadline') {
                                  FFAppState().updatePostStateStruct(
                                    (e) => e
                                      ..deadline =
                                          _model.calendarSelectedDay?.start,
