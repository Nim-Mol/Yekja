...
class ViewPostFilterTable extends SupabaseTable<ViewPostFilterRow> {
  @override
  String get tableName => 'view_post_filter';

  @override
  ViewPostFilterRow createRow(Map<String, dynamic> data) =>
      ViewPostFilterRow(data);
}

class ViewPostFilterRow extends SupabaseDataRow {
  ViewPostFilterRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewPostFilterTable();
