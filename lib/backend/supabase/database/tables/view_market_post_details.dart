...
class ViewMarketPostDetailsTable
    extends SupabaseTable<ViewMarketPostDetailsRow> {
  @override
  String get tableName => 'view_market_post_details';

  @override
  ViewMarketPostDetailsRow createRow(Map<String, dynamic> data) =>
      ViewMarketPostDetailsRow(data);
}

class ViewMarketPostDetailsRow extends SupabaseDataRow {
  ViewMarketPostDetailsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewMarketPostDetailsTable();
  ...
  List<String> get exchangeWishlistNames =>
      getListField<String>('exchange_wishlist_names');
  set exchangeWishlistNames(List<String>? value) =>
      setListField<String>('exchange_wishlist_names', value);
