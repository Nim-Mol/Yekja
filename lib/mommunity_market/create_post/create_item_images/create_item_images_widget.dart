...
import 'create_item_images_model.dart';
export 'create_item_images_model.dart';

class CreateItemImagesWidget extends StatefulWidget {
  const CreateItemImagesWidget({super.key});

  static String routeName = 'CreateItemImages';
  static String routePath = '/createItemImages';

  @override
  State<CreateItemImagesWidget> createState() => _CreateItemImagesWidgetState();
}

class _CreateItemImagesWidgetState extends State<CreateItemImagesWidget> {
  late CreateItemImagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateItemImagesModel());
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              context.pushNamed(
                                                CreateWishlistWidget.routeName,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            safeSetState(() {
                                                                              ...
                                                                              _model.uploadedLocalFile_uploadimageLocal = FFUploadedFile(bytes: Uint8List.fromList([]));
                                                                            });
                                                                          },
                                                                          child:
                                                                              Icon(
