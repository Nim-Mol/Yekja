...
class DetailTransferWidget extends StatefulWidget {
  const DetailTransferWidget({super.key});
...
class _DetailTransferWidgetState extends State<DetailTransferWidget> {
  ...
  void initState() {
    ...
    _model.registrationSwitchValue1 = FFAppState().postState.isDocument;
    _model.registrationSwitchValue2 = FFAppState().postState.isFragile;
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'transfer ${functions.toLowerCase(FFAppState().postState.intend)}',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .headlineLarge
                                                .override(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'c5xl91u5' /* Helps others understand your p... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          4.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        FFAppState().postState.intend == 'Offer'
                                            ? 'Travel Date:'
                                            : 'Transfer Deadline:',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'hvhdtgd2' /* Weight Class (swipe to see mor... */,
                                              ),
                                              textAlign: TextAlign.start,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '5ak8ya57' /* Dimensin Class (swipe to see m... */,
                                              ),
                                              textAlign: TextAlign.start,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                ...
                                                child: FlutterFlowChoiceChips(
                                                  options: [
                                                    ChipData(FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                      'nch1r3cv' /* Small (Fits Shoe Box) */,
                                                    )),
                                                    ChipData(FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                      'anz9yacn' /* Medium (Carry-On Size) */,
                                                    )),
                                                    ChipData(FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                      'b6fuebhp' /* Large (Check-in Luggage) */,
                                                    )),
                                                    ChipData(FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                  ...
                                                  onChanged: (val) async {
                                                    safeSetState(() =>
                                                        _model.sizeChoiceValue =
                                                            val?.firstOrNull);
                                                    FFAppState()
                                                        .updatePostStateStruct(
                                                      (e) => e
                                                        ..dimensionsText = _model
                                                            .sizeChoiceValue,
                                                    );
                                                    safeSetState(() {});
                                                  },
