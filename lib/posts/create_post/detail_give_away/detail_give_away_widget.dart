...
class DetailGiveAwayWidget extends StatefulWidget {
  const DetailGiveAwayWidget({super.key});
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'hh37t41a' /* Helps others understand your p... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      child: FlutterFlowChoiceChips(
                                        options: [
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'qfue4pwt' /* By Agreement */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'qrmukbp9' /* Pick-Up Only */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            '1ezxn1am' /* Sent by Post */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'k4ip6rn0' /* Free Delivery */,
                                          ))
                                        ],
                                        onChanged: (val) async {
                                          safeSetState(() =>
                                        ...
                                        multiselect: false,
                                        initialized:
                                            _model.deliveryChoiceValue != null,
                                                        ...
                                                        options: [
                                                          ChipData(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                            '22yth6md' /* Under €1,000 */,
                                                          )),
                                                          ChipData(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                            '6tvyq410' /* Under €2,000 */,
                                                          )),
                                                          ChipData(
                                                              FFLocalizations.of(
                                                                      context)
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'wcnqe1gw' /* Try item exchange, not just pa... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '7y6s1wlv' /* What items are you looking to ... */,
                                              ),
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: ErrorCompWidget(
                                          errorText: FFLocalizations.of(context)
                                              .getText(
                                            'n9gj6enp' /* Some fields are left unfilled.... */,
                                          ),
                                        ),
                                      ),
                                    );
