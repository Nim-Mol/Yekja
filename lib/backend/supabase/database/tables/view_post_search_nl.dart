...
class ViewPostSearchNlTable extends SupabaseTable<ViewPostSearchNlRow> {
  @override
  String get tableName => 'view_post_search_nl';

  @override
  ViewPostSearchNlRow createRow(Map<String, dynamic> data) =>
      ViewPostSearchNlRow(data);
}

class ViewPostSearchNlRow extends SupabaseDataRow {
  ViewPostSearchNlRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewPostSearchNlTable();
