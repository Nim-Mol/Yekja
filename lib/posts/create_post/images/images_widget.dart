                                                ...
                                                children: [
                                                  AutoSizeText(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'qnqqsif9' /* Select up to 4 images */,
                                                    ),
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    if (selectedMedia != null &&
                                                      ...
                                                      if (selectedUploadedFiles
                                                          ...
                                                          selectedMedia
                                                              .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFile_uploadimageLocalComp =
                                                              selectedUploadedFiles
                                                                  .first;
                                                        });
                                                      } else {
                                                    ...
                                                    _model.addToLocalImages(_model
                                                        .uploadedLocalFile_uploadimageLocalComp);
                                                    safeSetState(() {});
                                                  },
                                                  child: Icon(
                                                    Icons.add,
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                safeSetState(
                                                                  ...
                                                                  _model.isDataUploading_uploadimageLocalComp =
                                                                      false;
                                                                  _model.uploadedLocalFile_uploadimageLocalComp = FFUploadedFile(
                                                                      bytes: Uint8List
                                                                          .fromList(
                                                                              []),
                                                                      originalFilename:
