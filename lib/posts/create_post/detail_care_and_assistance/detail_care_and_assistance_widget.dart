...
class DetailCareAndAssistanceWidget extends StatefulWidget {
  const DetailCareAndAssistanceWidget({
    super.key,
    this.navRoute,
  });
...
class _DetailCareAndAssistanceWidgetState
    extends State<DetailCareAndAssistanceWidget> with TickerProviderStateMixin {
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'i1n166r0' /* Details build trust and save b... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                              ...
                              Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'zi6grwu2' /* Compensate the support */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleMedium
                                                .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '5stjqxif' /* Voluntary supports can be comp... */,
                                      ),
                                      maxLines: 2,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                            ...
                                            child: Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '20xkyxrc' /* Compensation possible */,
                                                  ),
                                                  style:
                                                      FlutterFlowTheme.of(
                                                              context)
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: ErrorPopUpWidget(
                                          errorText: FFLocalizations.of(context)
                                              .getText(
                                            'v6o4kog0' /* Some fields are empty. Please ... */,
                                          ),
                                        ),
                                      ),
                                    );
