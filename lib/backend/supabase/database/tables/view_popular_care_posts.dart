...
class ViewPopularCarePostsTable extends SupabaseTable<ViewPopularCarePostsRow> {
  @override
  String get tableName => 'view_popular_care_posts';

  @override
  ViewPopularCarePostsRow createRow(Map<String, dynamic> data) =>
      ViewPopularCarePostsRow(data);
}

class ViewPopularCarePostsRow extends SupabaseDataRow {
  ViewPopularCarePostsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewPopularCarePostsTable();
