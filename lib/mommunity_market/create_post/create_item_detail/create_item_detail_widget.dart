...
import 'create_item_detail_model.dart';
export 'create_item_detail_model.dart';

class CreateItemDetailWidget extends StatefulWidget {
  const CreateItemDetailWidget({super.key});

  static String routeName = 'CreateItemDetail';
  static String routePath = '/createItemDetail';

  @override
  State<CreateItemDetailWidget> createState() => _CreateItemDetailWidgetState();
}

class _CreateItemDetailWidgetState extends State<CreateItemDetailWidget> {
  late CreateItemDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateItemDetailModel());
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            CreateItemSubCatWidget.routeName,
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '${FFAppState().marketPlaceMeta.description != '' ? valueOrDefault<String>(
                                                        FFAppState()
                                                            .marketPlaceMeta
                                                            .description,
                                                  ...
                                                  valueOrDefault<String>(
                                                    () {
                                                      if (FFAppState()
                                                                ...
                                                                .timeUnit ==
                                                            '') {
                                                      return '€${FFAppState().marketPlaceMeta.price.toString()}';
                                                    } else {
                                                      return '€${FFAppState().marketPlaceMeta.price.toString()} / ${FFAppState().marketPlaceMeta.timeUnit}';
                                                    }
                                                    }(),
                                                    'Not Set',
                                                  ),
