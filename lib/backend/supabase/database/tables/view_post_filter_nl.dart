...
class ViewPostFilterNlTable extends SupabaseTable<ViewPostFilterNlRow> {
  @override
  String get tableName => 'view_post_filter_nl';

  @override
  ViewPostFilterNlRow createRow(Map<String, dynamic> data) =>
      ViewPostFilterNlRow(data);
}

class ViewPostFilterNlRow extends SupabaseDataRow {
  ViewPostFilterNlRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewPostFilterNlTable();
