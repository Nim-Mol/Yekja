                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '02ax6rz5' /* Details build trust and save b... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                          ...
                                          Container(
                                            ...
                                            child: Form(
                                              ...
                                              child: Container(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .capacityFieldTextController,
                                                  focusNode: _model
                                                      .capacityFieldFocusNode,
                                                  onChanged: (_) =>
                                                      EasyDebounce.debounce(
                                                    '_model.capacityFieldTextController',
                                                    Duration(
                                                        milliseconds: 2000),
                                                    () async {
                                                      if (_model.capacityFieldTextController
                                                                  .text !=
                                                              '') {
                                                        _model.validationResultCapacity =
                                                            true;
                                                        if (_model.formKey1
                                                                    .currentState ==
                                                                null ||
