...
class ViewRecentExchangeTable extends SupabaseTable<ViewRecentExchangeRow> {
  @override
  String get tableName => 'view_recent_exchange';

  @override
  ViewRecentExchangeRow createRow(Map<String, dynamic> data) =>
      ViewRecentExchangeRow(data);
}

class ViewRecentExchangeRow extends SupabaseDataRow {
  ViewRecentExchangeRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewRecentExchangeTable();
